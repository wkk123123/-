                                        ...
                                        <table width="100%"  class="cont"  >
                                            <tr>
                                                ...
                                                <td colspan="7"><input class="text" type="text" id="idNubmer" />
                                                     ...
                                                     <input type="button" id="btnReturn" value="归还" style="width: 80px;"/>
                                                    </td>
                                                </td>
                       ...
                       <!--详细信息-->
                                                ...
                                                <table width="100%"  class="cont tr_color">
                                                    ...
                                                    <c:if test="${records==null}">
                                                        <tr align="center" class="d">
                                                            <td colspan="8" ALIGN="center"><h3>暂无数据展示</h3></td>
                                                        </tr>
                                                    </c:if>
                                                    <c:if test ="${records!=null}">
                                                        <c:forEach items="${records}" var="r" >
                                                            <!--逾期的处理，取出record对象，当记录里面归还的时间早于系统当前时间-->
                                                            <%
                        ...
                        <tr>
                            ...
                            <td width="51%" class="left_txt">
                                <img src="./Images/icon_mail.gif" width="16" height="11"> 客户服务邮箱：1781767621@qq.com<br />
                            </td>
                            <td>&nbsp;</td><td>&nbsp;</td>
                        </tr>
                    </table>
